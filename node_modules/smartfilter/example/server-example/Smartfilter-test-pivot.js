...
var dbConfig = { type: "database", databaseType: 'mysql', database: 'axiomacc', host: "192.168.0.23", port: "3307", user: "usr", password: "usr", multipleStatements: false };
var mysmartfilter = new smartfilter();
//Step 1. Connect to mysql database
mysmartfilter.smartfilterRequest({ type: "connect", data: { tableName: "finaltdcdata", dbConfig: dbConfig} }, function (output) {
            ...
            if (output.type !== 'error') {
                ...
                mysmartfilter.smartfilterRequest({
                    ...
                    if (output.type !== 'error') {
                        ...
                        mysmartfilter.smartfilterRequest({ type: "removePivot", data: { reference: 'Pivot1'} }, function (output) {
                            console.log(output);
                            process.exit(0);
                        });
                        //                                                                            }
